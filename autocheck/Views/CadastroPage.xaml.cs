...
namespace autocheck.Views
{
    public partial class CadastroPage : ContentPage
    {
        ...
        private async void OnLoginClicked(object sender, EventArgs e)
        {
            ...
            {
                await DisplayAlert("Aten��o", "Preencha todos os campos para continuar.", "OK");
                return;
            }
            ...
            {
                await DisplayAlert("Erro", "O email precisa ser v�lido (@gmail, @outlook ou @hotmail).", "OK");
                return;
            }
            ...
            {
                await DisplayAlert("Aten��o", "O CPF deve conter 11 d�gitos num�ricos.", "OK");
                return;
            }
            ...
            {
                await DisplayAlert("Erro", "O telefone deve conter 11 d�gitos num�ricos.", "OK");
                return;
            }
        ...
        {
            bool confirmar = await DisplayAlert("J� possui cadastro?", "Deseja prosseguir?", "Sim", "N�o");
            if (confirmar)
            {
